...
define("vm-icon", VmIcon);
define("vm-tooltip", VmTooltip);
var SettingsControl_default = createComponent("vm-settings-control", /* @__PURE__ */ new Set(["icon", "icons", "tooltipPosition", "tooltipDirection", "menu", "expanded", "i18n", "hideTooltip"]));
