...
const GET_LESSON_BY_SLUG_QUERY = gql`
  query GetLessonsBySlug($slug: String = "slug") {
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="" className="p-4 text-sm border border-blue-500 text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 hover:text-gray-400">
              <Lightning size={24}/>
              Acesse os exercicíos
            </a>
          </div>
        </div>
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relaxed">
              <strong className="text-2xl">Acesso ao AVA</strong>
